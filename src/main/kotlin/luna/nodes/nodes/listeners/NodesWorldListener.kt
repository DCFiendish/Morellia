...
import luna.nodes.nodes.Nodes.getRelationshipOfPlayerToTown
import luna.nodes.nodes.constants.DiplomaticRelationship
import luna.nodes.nodes.constants.ErrorAlreadyCaptured
import luna.nodes.nodes.constants.ErrorAlreadyUnderAttack
import luna.nodes.nodes.constants.ErrorChunkNotEdge
import luna.nodes.nodes.constants.ErrorFlagTooHigh
import luna.nodes.nodes.constants.ErrorNoTerritory
import luna.nodes.nodes.constants.ErrorNotBorderTerritory
import luna.nodes.nodes.constants.ErrorNotEnemy
import luna.nodes.nodes.constants.ErrorSkyBlocked
import luna.nodes.nodes.constants.ErrorTooManyAttacks
import luna.nodes.nodes.constants.ErrorTownBlacklisted
import luna.nodes.nodes.constants.ErrorTownNotWhitelisted
import luna.nodes.nodes.constants.INTERACTIVE_BLOCKS
import luna.nodes.nodes.constants.PROTECTED_BLOCKS
...
import luna.nodes.nodes.war.Attack
