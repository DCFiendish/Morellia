...
| World-gen/persistence format (Anvil chosen for the real trimmed terrain, RESOLVED 2026-08-06), JVM/GC tuning, memory footprint, SLF4J binding | `minestom-server-setup/03-runtime-ops-and-logging.md`, `04-world-generation-and-persistence.md` |
